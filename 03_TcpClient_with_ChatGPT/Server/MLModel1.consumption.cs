...
namespace Server
{
    public partial class MLModel1
    {
        ...
        {
            [ColumnName(@"слово")]
            public float[] Слово { get; set; }

            [ColumnName(@"категорія")]
            public uint Категорія { get; set; }
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("категорія");
            if (labelColumn == null)
            {
                throw new Exception("категорія column not found. Make sure the name searched for matches the name in the schema.");
            }
